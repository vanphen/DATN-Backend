...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion"  style="background: #001757;" id="accordionSidebar">
   <!-- Sidebar - Brand -->
   <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ url('/superadmin/home') }}">
   ...
   <!-- Nav Item - Dashboard -->
   <li class="nav-item ">
      <a class="nav-link" href="{{ url('/superadmin/manage') }}" >
      <i class="fas fa-user-friends"></i>
      <span>Quản lí doanh nghiệp</span>
      </a>
   </li>
